...
import { ICandidateCVProfileCertifications, ICandidateCVWorkExperience } from 'src/app/_models/candidate/ICandidateCVProfile';
...
export class AddUpdateCertificationsComponent implements OnInit {
  obj:ICandidateCVProfileCertifications;
  UserForm = new FormGroup({
    title: new FormControl('', Validators.required),
    company: new FormControl('', Validators.required),
    validityFromDate: new FormControl('', Validators.required),
    validityToDate: new FormControl('', Validators.required)
  });
  constructor(
  ...
  saveData() {
    if (this.UserForm.valid) {
      ...
      this.loadingService.doLoading(
        this.service.addUpdateCertifications(this.obj), this).pipe(first())
        .subscribe((res) => {
          if (res.success) {
            Swal.fire({
              title: 'Success',
