...
@Component({
  selector: 'app-client-interview-details',
  templateUrl: './client-interview-details.component.html',
  styleUrls: ['./client-interview-details.component.css']
})
export class ClientInterviewDetailsComponent implements OnInit {
