 ...
 */
  ...
  const usersList = [
    {
      value: 1,
      name: "My Company",
      avatar: "../assets/img/offer_company_logo.png",
      email: "john@mycompany.com",
    },
    {
      value: 2,
      name: "ACME Corp",
      avatar: "../assets/img/company2_logo.jpg",
      email: "jasonlee@acme.org",
    },
  ];
  ...
  function onSelectSuggestion(e) {
    ...
    $("#spnClientMeetClient").html("<i class='bx bx-refresh bx-spin text-black'></i> <small>Checking...</small>");
    $("#divClientMeetClientSuggestion").html("");

    setTimeout("ClientAvailbilityCheckCompleted()", 1000);
  }
